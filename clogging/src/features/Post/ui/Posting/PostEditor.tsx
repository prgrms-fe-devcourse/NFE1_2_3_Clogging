  ...
  return (
    ...
    >
      ...
      <select
        ...
        className="w-full md:w-[300px] h-[35px] mb-8 px-4 border rounded-lg focus:outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-200 border-gray-200 dark:border-gray-700"
      >
      ...
      <div className="flex flex-col items-center">
        <input
          ...
          className="w-full text-xl md:text-[35px] font-bold text-center appearance-none border-none outline-none focus:outline-none focus:ring-0 mb-[20px] bg-transparent"
          style={{
        ...
        />
        <hr className="w-full md:w-[800px] border-0 bg-blue-100 dark:bg-blue-900 h-[2px] mb-8" />
      </div>
